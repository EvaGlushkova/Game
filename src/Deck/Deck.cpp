...
void Deck::shuffle() { std::shuffle(deck_.begin(), deck_.end(), rng_); }
...
int Deck::getCardCount() const { return deck_.size(); }

bool Deck::isEmpty() const { return deck_.empty(); }