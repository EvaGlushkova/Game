...
/**
 * @file AnimalCard.h
 * @brief Base class for all animal cards in the game
 */
...
public:
   ...
   */
  ~AnimalCard() override = default;

  /**
   * @brief Get the card type as "Animal"
  ...
  /**
   * @brief Get the base income value this card produces
